# [ADR-0068] Integrate JWT for tax-calculation
...
| Date        | 2024-04-15 |
| Status      | Proposed |
| Deciders    | Grace Lee, Jack Anderson, Jack Anderson |

## Context

Our tax-calculation implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use OpenID-Connect for our tax-calculation needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for tax-calculation
