# [ADR-0036] Migrate-to GitHub-Actions for currency-conversion
...
We will use RabbitMQ for our currency-conversion needs. This technology provides the features we need and aligns with our team's expertise.
