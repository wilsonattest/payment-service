# [ADR-0009] Use WebSockets for payment-reconciliation
...
| Date        | 2024-11-22 |
| Status      | Accepted |
| Deciders    | Grace Lee, Alice Chen, David Kim |
...
We will use Azure-Functions for our payment-reconciliation needs. This technology provides the features we need and aligns with our team's expertise.
