# [ADR-0061] Deploy WebSockets for currency-conversion
...
We will use gRPC for our currency-conversion needs. This technology provides the features we need and aligns with our team's expertise.
