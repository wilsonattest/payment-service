# [ADR-0034] Choose gRPC for transaction-processing
...
We will use OAuth-2.0 for our transaction-processing needs. This technology provides the features we need and aligns with our team's expertise.
