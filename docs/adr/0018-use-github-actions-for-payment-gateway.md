# [ADR-0018] Use GitHub-Actions for payment-gateway
...
We will use Elasticsearch for our payment-gateway needs. This technology provides the features we need and aligns with our team's expertise.
