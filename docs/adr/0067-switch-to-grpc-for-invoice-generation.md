# [ADR-0067] Switch-to gRPC for invoice-generation
...
We will use gRPC for our invoice-generation needs. This technology provides the features we need and aligns with our team's expertise.
