# [ADR-0046] Standardize-on Elasticsearch for payment-gateway
...
| Date        | 2024-08-03 |
| Status      | Proposed |
| Deciders    | Henry Brown, Jack Anderson, Henry Brown |

## Context

Our payment-gateway implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use MongoDB for our payment-gateway needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for payment-gateway
