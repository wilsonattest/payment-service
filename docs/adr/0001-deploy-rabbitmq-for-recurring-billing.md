# [ADR-0001] Deploy RabbitMQ for recurring-billing
...
We will use React for our recurring-billing needs. This technology provides the features we need and aligns with our team's expertise.
