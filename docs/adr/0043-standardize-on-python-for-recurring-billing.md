# [ADR-0043] Standardize-on Python for recurring-billing
...
We will use Kafka for our recurring-billing needs. This technology provides the features we need and aligns with our team's expertise.
