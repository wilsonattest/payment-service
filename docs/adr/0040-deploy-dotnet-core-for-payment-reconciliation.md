# [ADR-0040] Deploy DotNet-Core for payment-reconciliation
...
| Date        | 2023-05-05 |
| Status      | Accepted |
| Deciders    | David Kim, Eva Martinez, Bob Smith |
...
We will use MongoDB for our payment-reconciliation needs. This technology provides the features we need and aligns with our team's expertise.
