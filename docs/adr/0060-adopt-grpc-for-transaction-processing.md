# [ADR-0060] Adopt gRPC for transaction-processing
...
We will use AWS-Lambda for our transaction-processing needs. This technology provides the features we need and aligns with our team's expertise.
