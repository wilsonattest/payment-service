# [ADR-0011] Integrate MongoDB for payment-gateway
...
We will use Kafka for our payment-gateway needs. This technology provides the features we need and aligns with our team's expertise.
