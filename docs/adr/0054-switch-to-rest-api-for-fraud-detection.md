# [ADR-0054] Switch-to REST-API for fraud-detection
...
| Date        | 2023-12-17 |
| Status      | Superseded |
| Deciders    | Alice Chen, Iris Taylor, David Kim |

## Context

Our fraud-detection implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use DotNet-Core for our fraud-detection needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for fraud-detection
