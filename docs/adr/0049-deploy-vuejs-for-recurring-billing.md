# [ADR-0049] Deploy Vue.js for recurring-billing
...
We will use Azure-Functions for our recurring-billing needs. This technology provides the features we need and aligns with our team's expertise.
