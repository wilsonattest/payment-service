# [ADR-0051] Integrate Node.js for fraud-detection
...
We will use RabbitMQ for our fraud-detection needs. This technology provides the features we need and aligns with our team's expertise.
