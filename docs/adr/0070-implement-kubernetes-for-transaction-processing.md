# [ADR-0070] Implement Kubernetes for transaction-processing
...
| Date        | 2023-10-09 |
| Status      | Accepted |
| Deciders    | Grace Lee, Iris Taylor, Eva Martinez |

## Context

Our transaction-processing implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use DotNet-Core for our transaction-processing needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for transaction-processing
