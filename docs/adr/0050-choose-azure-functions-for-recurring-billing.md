# [ADR-0050] Choose Azure-Functions for recurring-billing
...
We will use GraphQL for our recurring-billing needs. This technology provides the features we need and aligns with our team's expertise.
