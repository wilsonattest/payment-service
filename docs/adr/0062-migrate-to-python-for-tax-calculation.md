# [ADR-0062] Migrate-to Python for tax-calculation
...
We will use Terraform for our tax-calculation needs. This technology provides the features we need and aligns with our team's expertise.
