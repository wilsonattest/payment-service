# [ADR-0005] Switch-to Azure-Functions for refund-handling
...
| Date        | 2025-12-22 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Henry Brown, Alice Chen |
...
We will use Docker for our refund-handling needs. This technology provides the features we need and aligns with our team's expertise.
