# [ADR-0024] Implement Terraform for chargeback-handling
...
| Date        | 2025-11-13 |
| Status      | Accepted |
| Deciders    | Grace Lee, Bob Smith, Frank Wilson |

## Context

Our chargeback-handling implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Elasticsearch for our chargeback-handling needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for chargeback-handling
