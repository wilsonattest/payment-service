# [ADR-0025] Integrate gRPC for pci-compliance
...
| Date        | 2023-11-02 |
| Status      | Accepted |
| Deciders    | Carol Johnson, Jack Anderson, Carol Johnson |

## Context

Our pci-compliance implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use React for our pci-compliance needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for pci-compliance
