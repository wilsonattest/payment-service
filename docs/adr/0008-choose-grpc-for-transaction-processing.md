# [ADR-0008] Choose gRPC for transaction-processing
...
| Date        | 2024-05-06 |
| Status      | Accepted |
| Deciders    | David Kim, Carol Johnson, Grace Lee |
...
We will use gRPC for our transaction-processing needs. This technology provides the features we need and aligns with our team's expertise.
