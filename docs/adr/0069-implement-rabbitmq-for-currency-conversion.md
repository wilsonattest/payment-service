# [ADR-0069] Implement RabbitMQ for currency-conversion
...
We will use React for our currency-conversion needs. This technology provides the features we need and aligns with our team's expertise.
