# [ADR-0026] Implement OpenID-Connect for currency-conversion
...
| Date        | 2024-11-20 |
| Status      | Proposed |
| Deciders    | Carol Johnson, Henry Brown, Jack Anderson |

## Context

Our currency-conversion implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Elasticsearch for our currency-conversion needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for currency-conversion
