# [ADR-0048] Standardize-on OAuth-2.0 for chargeback-handling
...
We will use GraphQL for our chargeback-handling needs. This technology provides the features we need and aligns with our team's expertise.
