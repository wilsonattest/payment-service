# [ADR-0039] Standardize-on Azure-Functions for recurring-billing
...
| Date        | 2024-12-06 |
| Status      | Proposed |
| Deciders    | David Kim, Alice Chen, David Kim |

## Context

Our recurring-billing implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Kubernetes for our recurring-billing needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for recurring-billing
