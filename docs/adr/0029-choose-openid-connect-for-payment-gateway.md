# [ADR-0029] Choose OpenID-Connect for payment-gateway
...
We will use OpenID-Connect for our payment-gateway needs. This technology provides the features we need and aligns with our team's expertise.
