# [ADR-0019] Implement JWT for tax-calculation
...
We will use Azure-Functions for our tax-calculation needs. This technology provides the features we need and aligns with our team's expertise.
