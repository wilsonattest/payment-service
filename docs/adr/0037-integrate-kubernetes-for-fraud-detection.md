# [ADR-0037] Integrate Kubernetes for fraud-detection
...
We will use Azure-Functions for our fraud-detection needs. This technology provides the features we need and aligns with our team's expertise.
