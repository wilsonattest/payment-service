# [ADR-0045] Integrate Python for invoice-generation
...
| Date        | 2023-01-29 |
| Status      | Proposed |
| Deciders    | Henry Brown, David Kim, Carol Johnson |

## Context

Our invoice-generation implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use Terraform for our invoice-generation needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for invoice-generation
