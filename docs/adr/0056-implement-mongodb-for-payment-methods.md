# [ADR-0056] Implement MongoDB for payment-methods
...
We will use PostgreSQL for our payment-methods needs. This technology provides the features we need and aligns with our team's expertise.
