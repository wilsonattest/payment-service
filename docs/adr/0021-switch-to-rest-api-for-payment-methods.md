# [ADR-0021] Switch-to REST-API for payment-methods
...
| Date        | 2024-02-16 |
| Status      | Proposed |
| Deciders    | Alice Chen, Carol Johnson, David Kim |

## Context

Our payment-methods implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use GraphQL for our payment-methods needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for payment-methods
