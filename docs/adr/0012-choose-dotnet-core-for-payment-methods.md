# [ADR-0012] Choose DotNet-Core for payment-methods
...
| Date        | 2025-03-23 |
| Status      | Accepted |
| Deciders    | Bob Smith, Grace Lee, Alice Chen |
...
We will use TypeScript for our payment-methods needs. This technology provides the features we need and aligns with our team's expertise.
