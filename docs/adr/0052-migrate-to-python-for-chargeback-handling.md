# [ADR-0052] Migrate-to Python for chargeback-handling
...
We will use REST-API for our chargeback-handling needs. This technology provides the features we need and aligns with our team's expertise.
