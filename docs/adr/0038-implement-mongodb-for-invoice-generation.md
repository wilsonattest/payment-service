# [ADR-0038] Implement MongoDB for invoice-generation
...
We will use GitHub-Actions for our invoice-generation needs. This technology provides the features we need and aligns with our team's expertise.
