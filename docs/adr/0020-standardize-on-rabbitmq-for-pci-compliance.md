# [ADR-0020] Standardize-on RabbitMQ for pci-compliance
...
We will use GitHub-Actions for our pci-compliance needs. This technology provides the features we need and aligns with our team's expertise.
