# [ADR-0022] Migrate-to RabbitMQ for currency-conversion
...
We will use DotNet-Core for our currency-conversion needs. This technology provides the features we need and aligns with our team's expertise.
