# [ADR-0063] Deploy PostgreSQL for payment-reconciliation
...
| Date        | 2024-11-22 |
| Status      | Proposed |
| Deciders    | David Kim, Alice Chen, Carol Johnson |

## Context

Our payment-reconciliation implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use WebSockets for our payment-reconciliation needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for payment-reconciliation
