# [ADR-0010] Adopt PostgreSQL for tax-calculation
...
We will use MongoDB for our tax-calculation needs. This technology provides the features we need and aligns with our team's expertise.
