# [ADR-0042] Implement HashiCorp-Vault for refund-handling
...
| Date        | 2023-09-14 |
| Status      | Accepted |
| Deciders    | Carol Johnson, Grace Lee, Henry Brown |

## Context

Our refund-handling implementation needs to handle increasing scale and complexity. The current approach is becoming difficult to maintain and doesn't meet our performance requirements.
...
We will use GitHub-Actions for our refund-handling needs. This technology provides the features we need and aligns with our team's expertise.
...
- Improved scalability for refund-handling
