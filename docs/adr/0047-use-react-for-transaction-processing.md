# [ADR-0047] Use React for transaction-processing
...
We will use MongoDB for our transaction-processing needs. This technology provides the features we need and aligns with our team's expertise.
