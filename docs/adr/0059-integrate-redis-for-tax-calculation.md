# [ADR-0059] Integrate Redis for tax-calculation
...
We will use Vue.js for our tax-calculation needs. This technology provides the features we need and aligns with our team's expertise.
