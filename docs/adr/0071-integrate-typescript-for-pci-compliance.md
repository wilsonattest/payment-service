# [ADR-0071] Integrate TypeScript for pci-compliance
...
We will use Docker for our pci-compliance needs. This technology provides the features we need and aligns with our team's expertise.
