# [ADR-0066] Adopt MongoDB for invoice-generation
...
| Date        | 2024-03-21 |
| Status      | Superseded |
| Deciders    | Grace Lee, Grace Lee, Jack Anderson |
...
We will use Python for our invoice-generation needs. This technology provides the features we need and aligns with our team's expertise.
