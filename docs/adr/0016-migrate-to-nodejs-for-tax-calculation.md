# [ADR-0016] Migrate-to Node.js for tax-calculation
...
We will use TypeScript for our tax-calculation needs. This technology provides the features we need and aligns with our team's expertise.
