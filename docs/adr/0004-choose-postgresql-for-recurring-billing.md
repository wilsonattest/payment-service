# [ADR-0004] Choose PostgreSQL for recurring-billing
...
We will use Terraform for our recurring-billing needs. This technology provides the features we need and aligns with our team's expertise.
