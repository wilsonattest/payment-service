# [ADR-0017] Adopt OAuth-2.0 for payment-gateway
...
We will use Vue.js for our payment-gateway needs. This technology provides the features we need and aligns with our team's expertise.
