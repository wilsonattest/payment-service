# [ADR-0033] Choose DotNet-Core for fraud-detection
...
We will use AWS-Lambda for our fraud-detection needs. This technology provides the features we need and aligns with our team's expertise.
