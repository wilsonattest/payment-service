# [ADR-0035] Deploy Redis for refund-handling
...
| Date        | 2024-08-15 |
| Status      | Accepted |
| Deciders    | Jack Anderson, Frank Wilson, Jack Anderson |
...
We will use AWS-Lambda for our refund-handling needs. This technology provides the features we need and aligns with our team's expertise.
