# [ADR-0031] Migrate-to DotNet-Core for currency-conversion
...
| Date        | 2023-08-13 |
| Status      | Accepted |
| Deciders    | Eva Martinez, Henry Brown |
...
We will use MongoDB for our currency-conversion needs. This technology provides the features we need and aligns with our team's expertise.
